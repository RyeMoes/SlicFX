...
<table>
  ...
  <tr bgcolor="#0d1117">
    <td align="left">
      Applied directly to the source you want to animate or move—not the scene the source is in—add up to 10 steps in a single filter. This virtually eliminates confusing, complex, and tedious filter chains.
    </td>
  </tr>
</table>
<br>
...
<table>
  ...
  <tr bgcolor="#161b22">
    <td align="left">
      Use this filter to crop or pad the bounds of a source using visual sliders while the source stays locked in place on your canvas. Traditional Crop/Pad controls are available as well.
    </td>
  </tr>
</table>
<br>
...
<table>
  ...
  <tr bgcolor="#161b22">
    <td align="left">
      Outline can hug a webcam cutout, mask, graphic, or any edged source. Shape the thickness and placement, then choose solid, shadow, glow, or bevel. After that, turn on an animation mode and the colors on the border will animate around the source.
    </td>
  </tr>
</table>
<br>
<table>
  ...
  <tr bgcolor="#0d1117">
    <td align="left">
      The absolute easiest way to get rounded corners on your webcam—or any other source—in OBS. Just drop this filter onto your source and drag the radius slider for perfect, procedural curved edges. Zero Photoshop mask files required.
    </td>
  </tr>
</table>
